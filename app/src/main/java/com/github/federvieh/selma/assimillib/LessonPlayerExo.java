 ...
 * @author frank
 */
public class LessonPlayerExo extends Service implements DelayService.DelayServiceListener, ExoPlayer.Listener {
    ...
    public static void stopPlaying(Context context) {
        Intent service = new Intent(context, LessonPlayerExo.class);
    ...
    public static void play(AssimilLesson lesson, int trackNo, boolean cont, Context ctxt) {
        ...
        if(trackPath!=null){
            ...
            Intent service = new Intent(ctxt, LessonPlayerExo.class);
